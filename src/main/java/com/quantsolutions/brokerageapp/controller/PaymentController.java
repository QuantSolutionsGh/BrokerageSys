...
import com.quantsolutions.brokerageapp.repository.PaymentDetailsRepository;
import com.quantsolutions.brokerageapp.repository.PolicyRepository;
    ...
    public String saveOrUpdatePayment(@ModelAttribute("paymentForm") @Validated PaymentDetails pd,
        ...
        if (result.hasErrors()){
           ...
           // return "redirect:/policies/"+pd.getPolicy().getId()+"/update";
            ...
            return "redirect:/policies/"+pd.getPolicy().getId().toString()+"/payments";
